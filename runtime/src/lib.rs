...
pub struct NiftGasWeightMapping;

impl pallet_evm::GasWeightMapping for NiftGasWeightMapping {
...
parameter_types! {
    pub const NiftTestnetChainId: u64 = 2160;
...
impl pallet_evm::Config for Runtime {
	...
	type GasWeightMapping = NiftGasWeightMapping;
	...
	type ChainId = NiftTestnetChainId;
